...
import { Key, MessageSquare, FileText, Blocks, Brain, Plug, Info, DatabaseBackup, HardDrive, Sliders, MousePointerClick, FlaskConical, Building2 } from 'lucide-react';
...
export const SETTINGS_SECTIONS: SectionNavItem[] = [
  ...
  { path: 'eln', getLabel: () => t('settings.nav.eln'), icon: FlaskConical },
  { path: 'lims', getLabel: () => t('settings.nav.lims'), icon: Building2 },
